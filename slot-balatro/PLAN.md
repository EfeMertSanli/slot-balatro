...
propt:
i want you to add a new mechanic to the game. i wanna be able to bet on each individual unlocked payline, the minmum is 1 and there is a button to change 
the defualt betting amount to  10 100 1000 and so on.
add poker chips to end of all the lines and add visuals to show how much is being bet on that line.
also change the payline mechanic, i want my game to have slower progression, i want the slot machine to max out around antee 7,
with 5 reels and all the lines open,



add a starting sequance to the game, where we play with out last 5 dollars on a fulled and maxxed out slot machine, lose, get a deal from the devil for gambling all our money back in exchange of our soul,
lose again and faint and wake up in the normal gameplay screen that we have and have luna explain us what happened to us. 


add boss portraits and the final rounds of the antees to be extra challenging, give a popup before each boss to remind players what modifiers the boss adds.